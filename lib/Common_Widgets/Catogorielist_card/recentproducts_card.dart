...
class RecentproductsCard extends StatefulWidget {
  final String name;
  ...
  const RecentproductsCard({
    ...
    required this.onBuyNow, // Made required
    this.onAdd,
    this.onFavorite,
    this.onTap,
  }) : super(key: key);
  ...
  @override
  State<RecentproductsCard> createState() => _RecentproductsCardState();
}

class _RecentproductsCardState extends State<RecentproductsCard> {
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: widget.onAdd,
                    child: Container(
                      height: SizeConfig.blockHeight * 2.6,
                      width: SizeConfig.blockHeight * 2.6,
                      decoration: BoxDecoration(
                        color: const Color(0xFF058F2F),
                        borderRadius: BorderRadius.circular(8),
                      ),
                      child: Icon(
                        Icons.add,
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: widget.onBuyNow, // Using the passed callback
                child: Container(
                  width: double.infinity,
